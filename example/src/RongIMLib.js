    ...
    var RongIMClient = (function () {
        ...
        RongIMClient.init = function (appKey, dataAccessProvider, options, callback) {
            ...
            var _defaultOpts = {
                ...
                openMp: true,
                snifferTime: 2000,
                cmp: 'navxiaoqiao.cn.ronghub.com:9889'
            };
        ...
        */
        ...
        RongIMClient.prototype.getChatroomMessageList = function (chatroomId, messageCount, callback) {
            RongIMClient._dataAccessProvider.getChatroomMessageList(chatroomId, messageCount, callback);
        };
...
(function (RongIMLib) {
    var ServerDataProvider = (function () {
        ...
        */
        ...
        ServerDataProvider.prototype.getChatroomMessageList = function (chatroomId, messageCount, callback) {
...
(function (RongIMLib) {
    var VCDataProvider = (function () {
        ...
        VCDataProvider.prototype.getChatroomMessageList = function (chatroomId, messageCount, callback) {
        };
